      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="space-y-4">
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block p-6 border border-gray-700 rounded-xl hover:border-blue-500/50 hover:bg-gray-800 transition-all group"
              >
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block p-6 border border-gray-700 rounded-xl hover:border-green-500/50 hover:bg-gray-800 transition-all group"
              >
                <div className="flex items-center justify-between">
                  <div>
        ...
        >
          <p className="text-sm text-gray-300">
            <strong className="text-white">Response Time:</strong> We typically respond to inquiries within 24-48 hours.
            For urgent support issues, please use our{' '}
